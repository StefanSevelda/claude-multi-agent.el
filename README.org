...
[[https://github.com/yourusername/claude-multi-agent.el/actions][https://github.com/yourusername/claude-multi-agent.el/workflows/Tests/badge.svg]]
[[https://github.com/yourusername/claude-multi-agent.el/blob/main/LICENSE][https://img.shields.io/badge/license-MIT-blue.svg]]
...
Tests are located in =test/= directory using ERT (Emacs Regression Testing).
